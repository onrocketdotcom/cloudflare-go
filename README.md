...
[![Go Reference](https://pkg.go.dev/badge/github.com/onrocketdotcom/cloudflare-go.svg)](https://pkg.go.dev/github.com/onrocketdotcom/cloudflare-go)
![Test](https://github.com/onrocketdotcom/cloudflare-go/workflows/Test/badge.svg)
[![Go Report Card](https://goreportcard.com/badge/github.com/onrocketdotcom/cloudflare-go?style=flat-square)](https://goreportcard.com/report/github.com/onrocketdotcom/cloudflare-go)
...
```
go get github.com/onrocketdotcom/cloudflare-go
```
...
import (
	...
	"github.com/onrocketdotcom/cloudflare-go"
)
...
Also refer to the
[API documentation](https://pkg.go.dev/github.com/onrocketdotcom/cloudflare-go) for
